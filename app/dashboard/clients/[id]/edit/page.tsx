...
export async function EditClientPage({ params }: { params: Promise<{ id: string }> }) {
      ...
      <div className="cfp">
        <div className="cfp-hd">
          <div className="cfp-left">
            ...
            <div>
              <h1 className="cfp-title"><span className="cfp-dot" aria-hidden />Editar Cliente</h1>
              <p className="cfp-sub">Modificando: <strong>{client.name}</strong></p>
            </div>
          </div>
        </div>
